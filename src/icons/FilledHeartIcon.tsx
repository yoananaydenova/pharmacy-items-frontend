...
const FilledHeartIcon = ({ width, height }: Icon) => {
    return (
        <svg width={width} height={height} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 512.002 512.002" xmlSpace="preserve" fill="#000000">
            ...
            <g id="SVGRepo_iconCarrier">
                ...
                <path
                    style={{ fill: "#573A32" }}
                    d="M255.998,492.613L467.01,281.601C527,221.612,527,124.366,467.01,64.377 c-29.995-29.995-69.299-44.988-108.612-44.988c-36.779,0-73.259,13.662-102.4,39.919c-29.15-26.257-65.621-39.919-102.4-39.919 c-39.313,0-78.618,14.993-108.612,44.988c-59.981,59.981-59.981,157.235,0,217.225L255.998,492.613z M63.085,82.476 c24.175-24.175,56.32-37.487,90.513-37.487c31.206,0,60.399,11.563,83.695,31.889l18.705,17.493l18.714-17.493 c23.296-20.318,52.489-31.889,83.686-31.889c34.193,0,66.33,13.312,90.513,37.487c49.911,49.903,49.903,131.115,0,181.018 L255.998,456.406L63.085,263.502C13.182,213.59,13.182,132.387,63.085,82.476z">
                </path>
            </g>
        </svg>
    )
